...
test("Boards Strings", () => {
	...
	const string2 =
		"./././././././././././././././././5SS3/4SS4/3IIII3/ hold J next STLZOS";
	const string3 =
		"./././././././././././././././././5SS3/4SS4/3IIII3/ hold J next STLZOS incoming 3,1,1";
	const string4 =
		"././././././././././././././././5SS3/4SS4/3IIII3/ hold J next STLZOS b2b 2";
	const string5 =
		"././././././././././././././././5SS3/4SS4/3IIII3/ hold J next STLZOS combo 3";
	const string6 =
		"././././././././././././././././5SS3/4SS4/3IIII3/ hold J next STLZOS incoming 3,1,1 b2b 2 combo 3";
...
test("Clear lines: Single Line", () => {
	const board = Board.fromString(
		"./././././././././././././././././././IIIIIIIIIII/ hold J next ITLZOS"
	);
	expect(board.clearLines()).toBe(1);
	expect(board.toString()).toBe(
		"././././././././././././././././././././ hold J next ITLZOS combo 1"
	);
});

test("Clear lines: Multiple Lines", () => {
	const board = Board.fromString(
		"./././././IIIIIIIIII/././././././././././././JJJJJJJJJJ/3IIII3/ hold J next ITLZOS"
	);
	expect(board.clearLines()).toBe(2);
	expect(board.toString()).toBe(
		"./././././././././././././././././././3IIII3/ hold J next ITLZOS combo 1"
	);
});
...
test("Garbage test: Loss", () => {
	...
	board.board = Array(18)
		.fill(Array(10).fill(8))
		.concat(Array(2).fill(Array(10).fill(0)));
	board.addGarbage();
